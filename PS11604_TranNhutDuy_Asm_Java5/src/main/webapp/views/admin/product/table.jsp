                        ...
                        <div class="col-sm-4">
                            <form action="/admin/product" method="post">
                            	<div class="input-group">
	                                <input type="text" name="keywords" value="${keywords}" class="form-control" id="txtKeyword">
                                        ...
                                        <thead>
                                            <tr class="ui-jqgrid-labels" role="rowheader">
                                                ...
                                                <th id="jqgrid_Name" role="columnheader" class="" style="width: 102px;">
                                                    <span class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
                                                    <div id="jqgh_jqgrid_Name" class="ui-jqgrid-sortable">Tên sản phẩm<span class="s-ico">
                                                ...
                                                <th id="jqgrid_ProductGroupName" role="columnheader" class="" style="width: 102px;">
                                                    <span class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
                                                    <div id="jqgh_jqgrid_ProductGroupName" class="ui-jqgrid-sortable">Danh mục<span class="s-ico" style="display:none">
                                                        <span sort="asc" class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr"></span>
                                                        <span sort="desc" class="ui-grid-ico-sort ui-icon-desc ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-ltr"></span></span>
                                                    </div>
                                                </th>
                                                ...
                                                <th id="jqgrid_Price" role="columnheader" class="" style="width: 102px;">
                                                    <span class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
                                                    <div id="jqgh_jqgrid_Price" class="ui-jqgrid-sortable">Giá<span class="s-ico" style="display:none">
                                                        <span sort="asc" class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr"></span>
                                                        <span sort="desc" class="ui-grid-ico-sort ui-icon-desc ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-ltr"></span></span>
                                                    </div>
                                                </th>
                                                <th id="jqgrid_Inactive" role="columnheader" class="" style="width: 68px;">
                                                    <span class="ui-jqgrid-resize ui-jqgrid-resize-ltr" style="cursor: col-resize;">&nbsp;</span>
                                                    <div id="jqgh_jqgrid_Inactive" class="ui-jqgrid-sortable">Ngày nhập<span class="s-ico" style="display:none">
                                                        <span sort="asc" class="ui-grid-ico-sort ui-icon-asc ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-ltr"></span>
                                                        <span sort="desc" class="ui-grid-ico-sort ui-icon-desc ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-ltr"></span></span>
                                                    </div>
                                                </th>
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach var="item" items="${page.content}">
	                                            <tr role="row" id="228544" tabindex="-1" class="ui-widget-content jqgrow ui-row-ltr" aria-selected="false">
	                                                <td role="gridcell" title="" style="text-align: center;" aria-describedby="jqgrid_act"><a href="/admin/product/edit/${item.id}" class="btn btn-xs btn-default" data-original-title="Edit Row"><i class="fa fa-pencil"></i></a><a href="/admin/product/delete/${item.id}" class="btn btn-xs btn-default" data-original-title="Save Row"><i class="fa fa-close"></i></a></td>
	                                                <td role="gridcell" title="" aria-describedby="jqgrid_Name">${item.name}</td>
	                                                <td role="gridcell" title="" aria-describedby="jqgrid_ProductGroupName">${item.category.name}</td>
	                                                <td role="gridcell" style="text-align:center;" title="" aria-describedby="jqgrid_Image"><img class="img-jqgrid-thumbnail" src="${item.image}"></td>
	                                                <td role="gridcell" style="text-align:right;" title="" aria-describedby="jqgrid_Price"><fmt:formatNumber value="${item.price}" pattern="###,###,###"/> VNĐ</td>
	                                                <td role="gridcell" style="text-align:center;" title="" aria-describedby="jqgrid_Inactive">${item.createDate}</td>
	                                            </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
