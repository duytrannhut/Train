			...
			<div class="row">
				<div class="footer-box col-md-3 col-sm-12 col-xs-12">
					...
					<ul>
						...
						<li><a href="/content/giao-hang-doi-tra.html"> Giao
								h&#224;ng - Đổi trả </a></li>
						<li><a href="/content/chinh-sach-bao-mat.html">
				...
				<div class="footer-box col-md-3 col-sm-12 col-xs-12">
					...
					<ul>
						<li><a href="/content/huong-dan-mua-hang.html"> Hướng dẫn
								mua h&#224;ng </a></li>
						<li><a href="/content/huong-dan-thanh-toan.html"> Hướng
								dẫn thanh to&#225;n </a></li>
						<li><a href="/content/tai-khoan-giao-dich.html"> T&#224;i
						...
						<div class="box-address-content">
							...
							<p>
								<i class="fa fa-envelope"></i> <a
									href="mailto:duytrannhut.xy@gmail.com">duytrannhut.xy@gmail.com</a>
							</p>
							<p>
								<i class="fa fa-phone"></i> Phone: 0123456789
							</p>
						</div>
					</div>
				</div>
				<div class="footer-box box-social col-md-3 col-sm-12 col-xs-12">
					<div class="item">
						...
						<div class="fb-like-box"
							data-href="https://www.facebook.com/runtime.vn" data-width="289"
							data-height="190" data-colorscheme="dark" data-show-faces="true"
							data-header="false" data-stream="false" data-show-border="false"></div>
						<div class="social-icon">
							<ul>
								<li><a target="_blank"><i class="fa fa-google-plus"></i></a></li>
								<li><a href="https://www.facebook.com/runtime.vn"
